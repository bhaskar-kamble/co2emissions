...
region_data_mfh <- region_data_mfh[region_data_mfh$abrechnungsjahr<2019 , ]
energy_prop_table_mfh <- energy_proportions_by_et(region_data_mfh,et_list)
region_data_sfh <- region_data_sfh[region_data_sfh$abrechnungsjahr<2019 , ]
