---
title: "CO<sub>2</sub> emissions for Ulm for 1-2 FH"
...
## Verbrauchsanteile der Energieträger - linear trends
...
plot_byET(datawide_linear,"Jahr","Anteile in Prozent", "Verbrauchsanteile der Energieträger, Ulm, 1-2 FH")
```
...
## Flächeanteile der Energieträger - data
...
grid.draw(tableGrob(APT_round,theme=ttheme_minimal(base_size = 8)))
```
...
## Flächeanteile der Energieträger - graph
```{r}
...
```{r}
plot_byET(area_prop_table_cumsums,"Jahr","Anteile in Prozent", "Flächeanteile nach Energieträger, Ulm, 1-2 FH")
```
...
## Flächeanteile der Energieträger - linear graph
...
```{r}
plot_byET(area_prop_cumsum_linear,"Jahr","Anteile in Prozent", "Flächeanteile nach Energieträger, Ulm, 1-2 FH")
```
...
grid.draw(tableGrob(totalAreaTab,theme=ttheme_minimal(base_size = 8)))
```
...
## Absolute area in Ulm split by Energietraeger - data
```{r}
...
grid.draw(tableGrob(ASA2,theme=ttheme_minimal(base_size = 8)))
```
...
## Absolute area in Ulm split by Energietraeger - graph
```{r}
...
```{r}
plot_byET(area_shares_absolute_cumsums,"Jahr","Fläche (qm)", "Fläche nach Energieträger, Ulm, 1-2 FH")
```
...
## Absolute area in Ulm split by Energietraeger - linear graph
...
```{r}
plot_byET(area_abs_cumsum_linear,"Jahr","Fläche (qm)", "Fläche nach Energieträger, Ulm, 1-2 FH")
```
...
## Absolute energy consumption split by Energieträgers - data
...
grid.draw(tableGrob(ESA2,theme=ttheme_minimal(base_size = 8)))
```
...
## Absolute energy consumption split by Energieträgers - graph
```{r}
drop_cols <- c("abrechnungsjahr","Yearlysum")
...
```{r}
plot_byET(energy_shares_absolute_cumsums,"Jahr","Verbrauch (kWh)", "Verbrauch nach Energieträger, Ulm, 1-2 FH")
```
...
## Absolute energy consumption split by Energieträgers - linear graph
...
```{r}
plot_byET(energy_abs_cumsum_linear,"Jahr","Verbrauch (kWh)", "Verbrauch nach Energieträger, Ulm, 1-2 FH")
```
...
## Relative energy consumption split by Energieträgers - data
...
grid.draw(tableGrob(ESR2,theme=ttheme_minimal(base_size = 8)))
```
...
## Relative energy consumption split by Energieträgers - graph
...
```{r}
plot_byET(energy_shares_relative_cumsums,"Jahr","Anteile in Prozent", "Verbrauch Anteile nach Energieträger, Ulm, 1-2 FH")
```
...
grid.draw(tableGrob(co2_coeff_tab,theme=ttheme_minimal(base_size = 8)))
```
...
## CO2 emissions by energieträger - data
...
grid.draw(tableGrob(co2_kilotons_tab,theme=ttheme_minimal(base_size = 8)))
```
...
## CO2 absolute split by energieträger - graph
```{r}
...
```{r}
plot_byET(co2_abs_cumsums,"Jahr","1.000 Tonnen", "CO2 nach Energieträger, Ulm, 1-2 FH")
```
...
## CO2 absolute split by energieträger - linear graph
...
```{r}
plot_byET(co2_abs_cumsums_linear,"Jahr","1.000 Tonnen", "CO2 nach Energieträger, Ulm, 1-2 FH")
```
...
## CO2 relative split by energieträger - data
```{r}
...
grid.draw(tableGrob(co2_relative_tab,theme=ttheme_minimal(base_size = 8)))
```
...
## CO2 relative split by energieträger - graph
...
```{r}
plot_byET(co2_relative_cumsums,"Jahr","Anteile in Prozent", "CO2 Anteile nach Energieträger, Ulm, 1-2 FH")
```
...
## CO2 relative split by energieträger - linear graph
...
```{r}
plot_byET(co2_rel_cumsums_linear,"Jahr","Anteile in Prozent", "CO2 Anteile nach Energieträger, Ulm, 1-2 FH")
```
