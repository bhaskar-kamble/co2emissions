---
title: "CO<sub>2</sub> emissions for Ulm for 1-2 FH buildings"
...
write.csv(totalArea,file="./data/presentations/ulm/sfh/totalArea_SFH.csv",row.names = FALSE)
write.csv2(totalArea,file="./data/presentations/ulm/sfh/totalArea_SFH_2.csv",row.names = FALSE)
```
