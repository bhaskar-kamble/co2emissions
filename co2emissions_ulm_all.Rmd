...
```{r}
write.csv(final_prop_table , file = "./data/ulm/all/ET_anteile_verbrauch_all.csv") #comes from co2online data
write.csv(spz_verbrauch_mean , file = "./data/ulm/all/spz_verbrauch_all.csv")      #comes from co2online data
# total area: wohngebaeude_2002_2018.txt contains the total area
write.csv(totalConsumption , file = "./data/ulm/all/gesamt_verbrauch_all.csv")     #comes from co2online and area data
write.csv(co2_emissions_in_kilo_tons , file = "./data/ulm/all/co2_emissions_kilo_tons_all.csv") #comes from co2online, coeff. and area data
```
