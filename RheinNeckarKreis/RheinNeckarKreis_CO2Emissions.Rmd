---
title: "Report on Rhein Neckar Kreis CO2 Emissions"
...
source("D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/mainCO2_RheinNeckarKreis.R")
...
```{r}
rnk_data <- sfh_data$region_data
#dim(rnk_data)
data.frame(table(rnk_data$abrechnungsjahr))
```


The sample size for SFH buildings is `r nrow(rnk_data)`.

## 1.`r (j <- j+1)`. Energy Proportions

```{r}
sfh_data$energy_prop_table
write.csv2(sfh_data$energy_prop_table , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/01_SFH_energyProportions.csv",row.names=FALSE)
```
...
write.csv2(sfh_data$area_prop_table , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/02_SFH_areaProportions.csv",row.names=FALSE)
...
sfh_data_area
write.csv2(sfh_data$totalArea , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/03_SFH_totalArea.csv",row.names=FALSE)
```

The coverage of SFH buildings is `r sum(rnk_data$gebaeude_nutzflaeche)/sfh_data_area$areaSFH[sfh_data_area$abrechnungsjahr==2018]`.
...
write.csv2(sfh_data$spz_verbrauch_mean , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/04_SFH_spz_verbrauch_mean.csv",row.names=FALSE)
```
...
write.csv2(sfh_data$totalConsumption , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/05_SFH_totalConsumption.csv",row.names=FALSE)
```
...
write.csv2(sfh_data$energy_shares_absolute , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/06_SFH_energy_shares_absolute.csv",row.names=FALSE)
```
...
```{r}
co2_SFH
write.csv2(co2_SFH , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/07_SFH_co2emissions.csv",row.names=FALSE)
```
...
```{r}
sum(rnk_data$gebaeude_nutzflaeche)
```

The sample size for MFH buildings is `r nrow(rnk_data)`.
...
write.csv2(mfh_data$energy_prop_table , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/01_MFH_energyProportions.csv",row.names=FALSE)
```
...
write.csv2(mfh_data$area_prop_table , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/02_MFH_areaProportions.csv",row.names=FALSE)
```
...
mfh_data_area
write.csv2(mfh_data$totalArea , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/03_MFH_totalArea.csv",row.names=FALSE)
sum(rnk_data$gebaeude_nutzflaeche)/mfh_data_area$areaMFH[mfh_data_area$abrechnungsjahr==2018]
```

The coverage of MFH buildings is `r sum(rnk_data$gebaeude_nutzflaeche)/mfh_data_area$areaMFH[mfh_data_area$abrechnungsjahr==2018]`.
...
write.csv2(mfh_data$spz_verbrauch_mean , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/04_MFH_spz_verbrauch_mean.csv",row.names=FALSE)
```
...
write.csv2(mfh_data$totalConsumption , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/05_MFH_totalConsumption.csv",row.names=FALSE)
```
...
write.csv2(mfh_data$energy_shares_absolute , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/06_MFH_energy_shares_absolute.csv",row.names=FALSE)
```
...
```{r}
co2_MFH
write.csv2(co2_MFH , file = "D:/GITHUB_REPOS/co2emissions/RheinNeckarKreis/Data/07_MFH_co2emissions.csv",row.names=FALSE)
```
