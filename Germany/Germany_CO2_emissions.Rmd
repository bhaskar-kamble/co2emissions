...
```{r}
plot_byET(co2_SFH_cumsums , "Jahr" , "mega t." , NULL)
```
...
```{r}
plot_byET(co2_MFH_cumsums , "Jahr" , "mega t." , NULL)
```
...
```{r}
plot_byET(co2_ALL_cumsums , "Jahr" , "mega t." , NULL)
```
...
plot_byET(co2_SFH_linear_cumsums , "Jahr" , "mega t." , NULL)
```
...
plot_byET(co2_MFH_linear_cumsums , "Jahr" , "mega t." , NULL)
```
...
plot_byET(co2_ALL_linear_cumsums , "Jahr" , "mega t." , NULL)
```
