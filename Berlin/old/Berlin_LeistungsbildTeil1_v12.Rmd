...
ggplot(prognose_sfh_lin , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynomial 1. Grades")
```

```{r}
from2002_till_2030 <- data.frame(abrechnungsjahr=2002:2030)
prognose_sfh_quad <- data.frame(abrechnungsjahr = 2002:2030 , pred = as.numeric(predict(quadmodel_sfh,newdata=from2002_till_2030)))
ggplot(prognose_sfh_quad , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynomial 2. Grades")
```
...
ggplot(prognose_mfh_lin , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynomial 1. Grades")
```

```{r}
from2002_till_2030 <- data.frame(abrechnungsjahr=2002:2030)
prognose_mfh_quad <- data.frame(abrechnungsjahr = 2002:2030 , pred = as.numeric(predict(quadmodel_mfh,newdata=from2002_till_2030)))
ggplot(prognose_mfh_quad , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynomial 2. Grades")
```
