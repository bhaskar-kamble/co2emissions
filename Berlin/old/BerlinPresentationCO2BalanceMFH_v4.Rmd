...
CO<sub>2</sub> emissions for Berlin for MFH buildings
...
## Flächeanteile nach Energieträger (qm)
...
## Verbrauch nach Energieträger (based on multivariate analysis)
...
## Verbrauch nach Energieträger (kWh)
...
## CO<sub>2</sub> coefficients (g/kWh)
```{r}
