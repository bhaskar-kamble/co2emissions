...
points_line_lm(input_data = berlin_co2_all,
               ...
               y_eq = 3600,
               size_eq = 4,
               plot_title = expression("CO"[2]*" Emissionen in Berlin, alle Wohngebäude"),
               xlab = "Jahr",
               ylab = "kilo t.")
```
...
plot_byET(co2_all_allebezirke_byET_cumsums , 
          xlabel = "Jahr" , 
          ylabel = "kilo t." , 
          plottitle = "CO2 Emissionen in Berlin, alle Wohngebäude, nach Energieträgern")
```
...
```{r}
plot_byBezirke(berlin_co2_all_cumsums , xlabel = "Jahr" , ylabel = "kilo t." , plottitle="CO2 Emissionen in Berlin, alle Wohngebäude, nach Bezirk")
```
...
```{r}
plot_byET(co2_all_allebezirke_byET_prop_cumsums,xlabel = "Jahr" , ylabel = "Anteile in %" , plottitle = "CO2 Emissionen in Berlin, alle Wohngebäude, \nAnteile nach Energieträgern")
```
...
plot_byBezirke(berlin_co2_all_prop_cumsums,xlabel = "Jahr" , ylabel = "Anteile in %" , plottitle = "CO2 Emissionen in Berlin, alle Wohngebäude, Anteile nach Bezirk")
```
...
plot_reqdColumns(berlin_co2_all,
                 ...
                 yColsName = "Bezirk",
                 yVar = "kilo t.",
                 plot_title = "CO2 Emissionen von Stadtbezirken, alle Wohngebäude")
```
...
points_line_lm(input_data = spez_co2_emission,
               ...
               y_eq = 20,
               size_eq = 4,
               plot_title = "Spezifische CO2 Emissionen in Berlin, alle Wohngebäude",
               xlab = "Jahr",
               ylab = "kg/qm")
```
...
plot_reqdColumns(bezirke_spez_co2,
                 ...
                 yColsName = "Bezirk",
                 yVar = "kg/qm",
                 plot_title = "Spezifische CO2 Emissionen von Stadtbezirken, alle Wohngebäude",
                 xlabel = "Jahr",
                 ylabel = "kilo t.")
```
...
ggplot(data=bezirke_spezco2_linear_2018,aes(x=bezirk,y=wert,fill=wert))+geom_bar(stat="identity")+scale_fill_gradient(
  low="green",high="red"
)+theme(legend.position="none",axis.text.x=element_text(angle=45,hjust=1))+labs(x=" ",y="kg/qm",title="Spezifische CO2 Emissionen 2018, alle Wohngebäude")#+coord_flip()
```
...
plot_spezCO2_2018(obj = bezirke_spezco2_linear_2018 , 
                  plot_title = "Spezifische CO2 Emissionen 2018, alle Wohngebäude")
```
...
points_line_lm(input_data = get2002as100(spez_co2_emission , "abrechnungsjahr"),
               ...
               y_eq = 60,
               size_eq = 4,
               plot_title = "Spezifische CO2 Emissionen in Berlin, 2002 Wert = 100",
               xlab = "Jahr",
               ylab = " ")
```
...
plot_devFromBerlin2018(bezirke_spezco2_linear_2018,
                       plot_title = "Abweichung von Berlin 2018, Spezifische CO2 Emissionen, Alle Wohngebäude",
                       ylabel = "kg/m2")
```
...
barPlot_delta2012(changeFrom2012(spez_co2_emission),
                  ylabel = "kg/m2",
                  plot_title = "Spezifische CO2 Berlin, Alle Wohngebäude, zentriert um 2012")
```
...
points_line_lm(input_data = berlin_co2_percapita,
               ...
               y_eq = 500,
               size_eq = 4,
               plot_title = "Pro Kopf CO2 Emissionen in Berlin, alle Wohngebäude",
               xlab = "Jahr",
               ylab = "kg")
```
...
plot_reqdColumns(berlin_bezirke_all_co2perhead,
                 ...
                 yColsName = "Bezirk",
                 yVar = "co2 kg/head",
                 plot_title = "Pro Kopf CO2 Emissionen von Stadtbezirken, alle Wohngebäude",
                 xlabel = "Jahr",
                 ylabel = "kg/Kopf")
```
...
points_line_lm(input_data = berlin_co2_percapita_2002as100,
               ...
               y_eq = 70,
               size_eq = 4,
               plot_title = "Pro Kopf CO2 Emissionen in Berlin, alle Wohngebäude,2002 Wert = 100",
               xlab = "Jahr",
               ylab = "CO2 Pro Kopf")
```
...
plot_reqdColumns(bezirk_prohead_2002As100_all,
                 ...
                 xlabel="Jahr",
                 ylabel = NULL,
                 plot_title = "Pro Kopf CO2 Emissionen in Stadtbezirken, alle Wohngebäude, 2002 Wert = 100")
```
...
plot_co2perhead_2018(bezirk_co2_percapita_linear_2018,
                     ylabel = "kg",
                     plot_title = "CO2 Emissionen pro Einwohner in Stadtbezirken 2018,\nAlle Wohngebäude")
```
...
plot_groupBar(data_long,"wert",NULL,"kg","CO2 Emissionen pro Einwohner, 2002 und 2018\nAlle Wohngebäude")
```
...
plot_groupBarPercent(data_long,
                     xlabel=NULL,
                     ylabel = NULL,
                     plot_title = "pro Kopf CO2 Emissionen 2018, 2002 Wert = 100")
```
...
points_line_lm(input_data = berlin_co2_sfh,
               ...
               y_eq = 700,
               size_eq = 4,
               plot_title = "CO2 Emissionen in Berlin, 1-2 Familiengebäude",
               xlab = "Jahr",
               ylab = "kilo t.")
```
...
#co2_all_allebezirke_byET_cumsums
plot_byET(co2_sfh_allebezirke_byET_cumsums , xlabel = "Jahr" , ylabel = "kilo t." , plottitle = "CO2 Emissionen in Berlin, 1-2 Familiengebäude, nach Energiträger")
```
...
plot_byBezirke(berlin_co2_sfh_cumsums , xlabel = "Jahr" , ylabel = "kilo t." , plottitle="CO2 Emissionen in Berlin, 1-2 Familiengebäude, nach Bezirk")
```
...
plot_byET(co2_sfh_allebezirke_byET_prop_cumsums,xlabel = "Jahr" , ylabel = "Anteile in %" , plottitle = "CO2 Emissionen in Berlin, 1-2 Familiengebäude, \nAnteile nach Energieträgern")
```
...
plot_byBezirke(berlin_co2_sfh_prop_cumsums,xlabel = "Jahr" , ylabel = "Anteile in %" , plottitle = "CO2 Emissionen in Berlin, 1-2 Familiengebäude, Anteile nach Bezirk")
```
...
plot_reqdColumns(berlin_co2_sfh,
                 ...
                 yColsName = "Bezirk",
                 yVar = "CO2 Emissions",
                 plot_title = "CO2 Emissionen von Stadtbezirken, 1-2 Familiengebäude",
                 xlabel = "Jahr",
                 ylabel = "kilo t.")
```
...
points_line_lm(input_data = spez_co2_sfh,
               ...
               y_eq = 35,
               size_eq = 4,
               plot_title = "Spezifische CO2 Emissionen in Berlin, 1-2 Familiengebäude",
               xlab = "Jahr",
               ylab = "kg/qm")
```
...
plot_reqdColumns(bezirke_spez_co2_sfh,
                 ...
                 xlabel = "Jahr",
                 ylabel = "kg / qm",
                 plot_title = "Spezifische CO2 Emissionen von Stadtbezirken,\n1-2 Familiengebäude")
```
...
plot_spezCO2_2018(obj = bezirke_spezco2_sfh_linear_2018 , 
                  plot_title = "Spezifische CO2 Emissionen 2018, 1-2 Familiengebäude")
```
...
points_line_lm(input_data = get2002as100(spez_co2_sfh , "abrechnungsjahr"),
               ...
               y_eq = 60,
               size_eq = 4,
               plot_title = "Spezifische CO2 Emissionen in Berlin, 1-2 Familiengebäude, 2002 Wert = 100",
               xlab = "Jahr",
               ylab = " ")
```
...
plot_devFromBerlin2018(bezirke_spezco2_sfh_linear_2018,
                       "Abweichung von Berlin 2018, Spezifische CO2 Emissionen",
                       "kg/m2")
```
...
```{r}
barPlot_delta2012(changeFrom2012(spez_co2_sfh) , "kg/m2" , "Spezifische CO2 Berlin, 1-2 Familiengebäude, zentriert um 2012")
```
...
plot_reqdColumns(bezirk_co2_percapita_sfh,
                 ...
                 xlabel = "Jahr",
                 ylabel = "kg",
                 plot_title = "CO2 Emissionen pro Kopf, 1-2 FH")
```
...
points_line_lm(input_data = berlin_co2_mfh,
               ...
               y_eq = 2000,
               size_eq = 4,
               plot_title = "CO2 Emissionen in Berlin, Mehrfamiliengebäude",
               xlab = "Jahr",
               ylab = "kilo t.")
```
...
```{r}
plot_byET(co2_mfh_allebezirke_byET_cumsums , xlabel = "Jahr" , ylabel = "kilo t." , plottitle = "CO2 Emissionen in Berlin, Mehrfamiliengebäude, nach Energieträgern")
```
...
plot_byBezirke(berlin_co2_mfh_cumsums , xlabel = "Jahr" , ylabel = "kilo t." , plottitle="CO2 Emissionen in Berlin, Mehrfamiliengebäude, nach Bezirk")
```
...
plot_byET(co2_mfh_allebezirke_byET_prop_cumsums,xlabel = "Jahr" , ylabel = "Anteile in %" , plottitle = "CO2 Emissionen in Berlin, Mehrfamiliengebäude, \nAnteile nach Energieträgern")
```
...
plot_byBezirke(berlin_co2_mfh_prop_cumsums,xlabel = "Jahr" , ylabel = "Anteile in %" , plottitle = "CO2 Emissionen in Berlin, Mehrfamiliengebäude, Anteile nach Bezirk")
```
...
plot_reqdColumns(berlin_co2_mfh,
                 ...
                 xlabel = "Jahr",
                 ylabel = "kilo t.",
                 plot_title = "CO2 Emissionen von Stadtbezirken, Mehrfamiliengebäude")
```
...
points_line_lm(input_data = spez_co2_mfh,
               ...
               y_eq = 25,
               size_eq = 4,
               plot_title = "Spezifische CO2 Emissionen in Berlin, Mehrfamiliengebäude",
               xlab = "Jahr",
               ylab = "kg/qm")
```
...
plot_spezCO2_2018(obj = bezirke_spezco2_mfh_linear_2018 , 
                  plot_title = "Spezifische CO2 Emissionen 2018, Mehrfamiliengebäude")
```
...
points_line_lm(input_data = get2002as100(spez_co2_mfh , "abrechnungsjahr"),
               ...
               y_eq = 60,
               size_eq = 4,
               plot_title = "Spezifische CO2 Emissionen in Berlin, Mehrfamiliengebäude, 2002 Wert = 100",
               xlab = "Jahr",
               ylab = " ")
```
...
plot_devFromBerlin2018(bezirke_spezco2_mfh_linear_2018,
                       "Abweichung von Berlin 2018, Spezifische CO2 Emissionen Mehrfamiliengebäude",
                       "kg/m2")
```
...
```{r}
barPlot_delta2012(changeFrom2012(spez_co2_mfh), "kg/m2" , "Spezifische CO2 Berlin, Mehrfamiliengebäude, zentriert um 2012")
```
...
plot_reqdColumns(bezirk_co2_percapita_mfh,
                 ...
                 xlabel = "Jahr",
                 ylabel = "kg",
                 plot_title = "CO2 Emissionen pro Kopf, MFH")
```
...
```{r}
data.frame(Jahr=2002:2018 , area=bezirk_areas_all$total,
...
plot_reqdColumns(aes_by_bezirk_TWh_sfh,
                 ...
                 xlab = "Jahr",
                 ylab = "TWh",
                 plot_title = "Energieverbrauch in Stadtbezirken,\n1-2 Familiengebäude")
```
