---
title: "CO<sub>2</sub> emissions for berlin for 1-2 FH buildings"
...
berlin_sfh <- subset_data_by_region(SFH20022018,"berlin")
...
## Verbrauchsanteile nach Energieträger - linear graph
...
## Verbrauch nach Energieträgers - data
...
## Verbrauch nach EnergietrÃ¤ger - data
...
## Verbrauch nach Energieträgers - graph
```{r}
drop_cols <- c("abrechnungsjahr","Yearlysum")
...
## Verbrauch nach Energieträgers - linear graph
...
## Verbrauchsanteile nach Energieträgers - data
...
## Verbrauchsanteile nach Energieträgers - graph
...
write.csv(area_shares_absolute,file="./data/presentations/berlin/sfh/area_abs_ET_SFH.csv",row.names = FALSE)
write.csv2(area_shares_absolute,file="./data/presentations/berlin/sfh/area_abs_ET_SFH_2.csv",row.names = FALSE)

write.csv(energy_shares_absolute,file="./data/presentations/berlin/sfh/energy_abs_ET_SFH.csv",row.names = FALSE)
write.csv2(energy_shares_absolute,file="./data/presentations/berlin/sfh/energy_abs_ET_SFH_2.csv",row.names = FALSE)

write.csv(co2_emissions_in_kilo_tons,file="./data/presentations/berlin/sfh/co2_abs_ET_SFH.csv",row.names = FALSE)
write.csv2(co2_emissions_in_kilo_tons,file="./data/presentations/berlin/sfh/co2_abs_ET_SFH_2.csv",row.names = FALSE)

write.csv(totalArea,file="./data/presentations/berlin/sfh/totalArea_SFH.csv",row.names = FALSE)
write.csv2(totalArea,file="./data/presentations/berlin/sfh/totalArea_SFH_2.csv",row.names = FALSE)
```
