...
## \textcolor{black}{Verbrauchsanteile nach Energieträger - linear trends}
...
## \textcolor{black}{Flächeanteile nach Energieträger - graph}
```{r}
...
## \textcolor{black}{Flächeanteile nach Energieträger - linear graph}
...
## \textcolor{black}{Fläche nach Energietraeger (qm)}
```{r}
...
## \textcolor{black}{Fläche nach Energietraeger - graph}
```{r}
...
## \textcolor{black}{Fläche nach Energietraeger - linear graph}
...
## \textcolor{black}{Verbrauch nach Energieträger - graph}
```{r}
drop_cols <- c("abrechnungsjahr","Yearlysum")
...
## \textcolor{black}{Verbrauch nach Energieträger - linear graph}
...
## \textcolor{black}{CO$_2$ emissions - total graph}
```{r}
...
## \textcolor{black}{CO$_2$ nach energieträger - graph}
```{r}
...
## \textcolor{black}{CO$_2$ nach energieträger - linear graph}
...
## \textcolor{black}{CO$_2$ Anteile nach energieträger - data}
```{r}
...
## \textcolor{black}{CO$_2$ Anteile nach energieträger - graph}
...
## \textcolor{black}{CO$_2$ Anteile nach energieträger - linear graph}
...
## \textcolor{black}{Spezifische CO$_2$ Emission}
```{r}
