...
```{r}
require(ggplot2)
ggplot(berlin_sample_size$MFH) + geom_point(aes(x=abrechnungsjahr,y=get(bezirk)))+labs(x="Jahr",y="Stichprobengr??e",title=paste0(bezirk_proper_name , ", Mehrfamiliengeb?ude (Stichprobengröße)"))+scale_x_continuous(breaks=seq(2002,2018,2))
```
