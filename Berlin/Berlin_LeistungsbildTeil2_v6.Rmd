...
plot_dualPlot(
  ...
  2002:2018,
  "Jahr",
  "Nutzfläche, alle Wohngebäude (Mio. q.m.)",
  "kg/q.m.",
  "Nutzfläche",
  "spezifische CO2 Emissionen")
```
...
```{r}
plot_dualPlot(SV_all_byET$areas$total,
...
```{r}
plot_dualPlot(SV_sfh_byET$areas$total,
...
```{r}
plot_dualPlot(SV_mfh_byET$areas$total,
