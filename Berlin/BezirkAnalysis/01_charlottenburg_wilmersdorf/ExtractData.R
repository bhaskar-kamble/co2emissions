...
for (i in 1:12) {
  ...
  filename_sfh <- paste0(bezirk_number , "_" , bezirk , "_" , "SFH" , "_" , "CO2Emissions" , ".csv")
  filename_mfh <- paste0(bezirk_number , "_" , bezirk , "_" , "MFH" , "_" , "CO2Emissions" , ".csv")
  filename_all <- paste0(bezirk_number , "_" , bezirk , "_" , "ALL" , "_" , "CO2Emissions" , ".csv")
  
  write.csv2(co2_SFH_lin , file = paste0(bezirk_path , filename_sfh) , row.names = FALSE)
  write.csv2(co2_MFH_lin , file = paste0(bezirk_path , filename_mfh) , row.names = FALSE)
  write.csv2(co2_ALL_lin , file = paste0(bezirk_path , filename_all) , row.names = FALSE)
