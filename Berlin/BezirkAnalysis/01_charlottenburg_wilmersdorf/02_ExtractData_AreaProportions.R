...
path_to_file <- "D:/GITHUB_REPOS/co2emissions/Berlin/BezirkAnalysis/CO2LinearTrendForBezirke/02_Area_Proportions/"
...
for (i in 1:12) {
  ...
  write.csv2(APT_SFH_lin,file=paste0(path_to_file , file_name_sfh) , row.names = FALSE)
