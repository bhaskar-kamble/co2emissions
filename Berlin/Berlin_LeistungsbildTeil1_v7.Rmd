...
1.	You have the population statistics for entire Berlin, MFH+SFH combined, i.e. how many people live in SFH flats and how many in MFH flats. You have the number of SFH and MFH flats in Berlin. So fins out many people live in each MFH flat, and how many people live in each SFH flat.

2.	Now take Bezirk X. You have the number of flats in Bezirk X; look at for instance D: /GITHUB_REPOS/co2emissions/Berlin/FindArea/year2015.csv etc. You also have the population of the bezirk. From point 2, you found out how many people live on an average in each MFH flat and in each SFH flat. Multiply the number of MFH flats in Bezirk X with the number of people living in each MFH flat. This gives the number of people in MFH flats in Bezirk X. Likewise find how many people live in SFH flats in Bezirk X. The sum should ideally equal the population of the Bezirk.
