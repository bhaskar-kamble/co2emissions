...
```{r}
require(ggplot2)
ggplot(berlin_sample_size$ALL) + geom_point(aes(x=abrechnungsjahr,y=total))+labs(x="Jahr",y="Stichprobengröße",title="Berlin, Alle Wohngebäude")+scale_x_continuous(breaks=seq(2002,2018,2))
```
...
points_line_lm(input_data = berlin_co2_all,
               ...
               y_eq = 3600,
               size_eq = 4,
               plot_title = "CO2 Emissionen in Berlin, alle Wohngebäude",
               xlab = "Jahr",
               ylab = "kilo t.")
```
