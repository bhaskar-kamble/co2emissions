...
```{r}
showResults <- "show" # the options are "show" or "hide"
```
...
Stichprobengröße nach Bezirken:
...
```{r}
# * Berlin, summed over all Bezirke and all Energietr?ger.
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, MFH + 1-2 FH, CO2-Emission aus der Beheizung von Wohnraum 2002-2018, Ver?nderung in Prozent
...
## `r i_section`.`r i_subsection` Fl?chenbezug

```{r}
i_subsubsection <- 1
```

### `r i_section`.`r i_subsection`.`r i_subsubsection` Berlin, MFH + 1-2 FH, fl?chenbezogene co2 Emission aus der Beheizung von Wohnraum 2002-2018 in kg/m2 [AN]
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, MFH + 1-2 FH, fl?chenbezogene co2 Emission aus der Beheizung von Wohnraum 2002-2018 in kg/m2 [AN]
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, MFH + 1-2 FH, fl?chenbezogene co2 Emission aus der Beheizung von Wohnraum im Jahr 2018 in kg/m2 [AN]
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Berlin, fl?chenbezogene co2 Emission aus Beheizung von Wohnraum nach Stadtbezirken, 2002-2008, 2002=100
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Alle Stadtbezirke, alle Wohngeb?ude, fl?chenbezogene co2 Emission aus der Beheizung von Wohnraum, Entwicklung 2002-2018 und Niveau 2018 (Rang-folge)
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Berlin, alle Wohngeb?ude, durchschnittliche Emissionsminderung je qm Nutzfl?che im Zeitraum 2002-2018
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, alle Wohngeb?ude, co2-Emission aus der Beheizung von Wohnraum pro Einwohner
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, alle Wohngeb?ude, co2-Emission pro Einwohner aus der Beheizung von Wohnraum, 2002-2018, 2002=100 
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, alle Wohngeb?ude, co2-Emission aus der Beheizung von Wohnraum pro Einwohner, Niveau im Jahr 2018 in t/Einwohner
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, alle Wohngeb?ude, co2-Emission aus der Beheizung von Wohnraum pro Einwohner, Ver?nderung 2002/2018 in Prozent
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Berlin, alle Wohngebäude, Prognose der co2-Emission aus Beheizung 2019-2030 in Mio. t (Trend Polynom 1. Grades)
...
prognose <- data.frame(abrechnungsjahr = 2002:2030 , pred = as.numeric(predict(linmodel,newdata=from2002_till_2030)))
```
...
# `r i_section`. Alle Stadtbezirke, co2-emission aus Beheizung, 1-2 Familiengeb?ude
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, 1-2 Familiengeb?ude, co2-emissionen aus der Beheizung von Wohnraum 2002-2018 summiert in 1.000 t
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, 1-2 Familiengeb?ude, co2-emissionen aus der Beheizung von Wohnraum 2002-2018 in 1.000 t
...
### `r i_section`.`r i_subsection`.`r i_subsubsection` Stadtbezirke, 1-2 Familiengeb?ude, co2-emissionen aus der Beheizung von Wohnraum 2002-2018, Ver?nderung in Prozent
...
createTable(berlin_co2_sfh_devFromMean[ , c(1,8:13)],
            fontSize = 10,
            isHeader = TRUE,
            headerName = "Berlin, 1-2 Familiengeb?ude, CO2 Emissionen nach Bezirken, Abweichung vom jährlichen Mittelwert (%)",
            columnNames =  c("Jahr","Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick"),
            columnWidths = rep(1,7),
            columnsToRound = c("Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick")
)
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Stadtbezirke, 1-2 Familiengeb?ude, fl?chenbezogene CO2-Emission aus Beheizung von Wohnraum 2002 - 2008 in kg/m2[AN]
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Stadtbezirke, 1-2 Familiengeb?ude, fl?chenbezogene CO2-Emission aus der Beheizung von Wohnraum im Jahr 2018 in kg/m2[AN]
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Berlin, 1-2 Familiengeb?ude, fl?chenbezogene CO2-Emission aus Beheizung von Wohnraum nach Stadtbezirken, 2002 - 2008, 2002 = 100
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Alle Stadtbezirke, 1-2 Familiengeb?ude, fl?chenbezogene CO2-Emission aus der Beheizung von Wohnraum, Entwicklung 2002 - 2018 und Niveau 2018 (Rang?folge)
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Berlin, 1-2 Familiengeb?ude, durchschnittliche Emissionsminderung je qm Nutzfl?che im Zeitraum 2012 - 2018
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Stadtbezirke, 1-2 Familiengeb?ude, CO2-Emission aus der Beheizung von Wohnraum pro Einwohner
...
createTable(bezirk_co2_percapita_sfh[ , c(1,8:13)],
            isHeader = TRUE,
            headerName = "Bezirke, 1-2 Familiengeb?ude, Pro Kopf CO2 Emissionen (kg)",
            columnNames =  c("Jahr","Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick"),
            columnWidths = rep(1,7),
            columnsToRound = c("Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick")
)
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Stadtbezirke, Mehrfamiliengebäude, CO2-Emissionen aus der Beheizung von Wohnraum 2002 - 2018, Ver?nderung in Prozent
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Stadtbezirke, Mehrfamiliengebäude, Ver?nderung der CO2-Emission aus der Beheizung von Wohnraum 2002 - 2018 in Prozent
...
createTable(bezirk_co2_percapita_mfh[ , c(1,8:13)],
            isHeader = TRUE,
            headerName = "Bezirke, Mehrfamiliengeb?ude, Pro Kopf CO2 Emissionen (kg)",
            columnNames =  c("Jahr","Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick"),
            columnWidths = rep(1,7),
            columnsToRound = c("Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick")
)
...
### `r i_section`.`r i_subsection`.`r i_subsubsection`. Berlin, Mehrfamiliengebäude, Prognose der CO2-Emission aus Beheizung 2019 - 2030 in Mio. t (Trend Polynom 2. Grades)
...
createTable(aes_by_bezirk_TWh_sfh[ , c(1,8:13)],
            fontSize = 10,
            isHeader = TRUE,
            headerName = "Berliner, 1-2 Familiengeb?ude, Heizenergieverbrauch nach Bezirken (TWh)",
            columnNames =  c("Jahr","Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick"),
            columnWidths = rep(1,7),
            columnsToRound = c("Pankow","Reinickendorf","Spandau","Steglitz-\nZehlendorf","Tempelhof-\nSchöneberg","Treptow-\nKöpenick"),
            roundOffTo = 3
...
## `r i_section`.`r i_subsection`. Stadtbezirke, 1-2 Familiengeb?ude, flächenbezogener Heizenergieverbrauch 2002 - 2018 in kWh/(m2[AN]*a) 
...
## `r i_section`.`r i_subsection`. Stadtbezirke, Mehrfamiliengeb?ude Wohngebäude, Heizenergieverbrauch 2002 - 2018
...
# Sample size in Bezirken, alle Wohngeb?ude
