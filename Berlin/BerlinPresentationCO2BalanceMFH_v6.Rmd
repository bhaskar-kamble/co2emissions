---
title: "CO$_2$ Emissionen aus Mehrfamiliengebäuden: Berlin"
...
CO$_2$ emissions for Berlin for MFH buildings
...
```{r}
berlin_mfh_counts <- as.data.frame(table(berlin_mfh$abrechnungsjahr))
names(berlin_mfh_counts) <- c("abrechnungsjahr" , "mfh_counts")
write.csv2(berlin_mfh_counts , file = "./data/presentations/mfh/berlin_mfh_counts.csv")
require(dplyr)
by_year <- group_by(berlin_mfh , abrechnungsjahr)
berlin_mfh_area_sums <- as.data.frame(summarize(by_year , sum(gebaeude_nutzflaeche)))
names(berlin_mfh_area_sums) <- c("abrechnungsjahr" , "sum_nutzflaeche")
write.csv2(berlin_mfh_area_sums , file = "./data/presentations/mfh/berlin_mfh_area_sums.csv")
```
...
## \textcolor{black}{Verbrauchsanteile nach Energieträger}
...
## \textcolor{black}{Berlin, MFH, Verbrauchsanteile nach Energieträger}
...
## \textcolor{black}{Flächeanteile nach Energieträger (qm)}
...
## \textcolor{black}{Berlin, MFH, Flächenanteile nach Energieträger}
```{r}
...
## \textcolor{black}{Fläche nach Energieträger (qm)}
```{r}
...
## \textcolor{black}{Berlin, MFH, Fläche nach Energietraeger}
```{r}
...
plot_byET(area_shares_absolute_MioQM,"Jahr","Fläche (Mio. qm)", plot_title)
```
...
plot_byET(area_abs_MioQM_linear,"Jahr","Fläche (Mio. qm)", plot_title)
```
...
## \textcolor{black}{Verbrauch nach Energieträger (based on multivariate analysis)}
...
## \textcolor{black}{Verbrauch nach Energieträger (kWh)}
...
## \textcolor{black}{Berlin, MFH, Verbrauch nach Energieträger}
```{r}
drop_cols <- c("abrechnungsjahr","Yearlysum")
...
## \textcolor{black}{Verbrauchsanteile nach Energieträger - data}
...
## \textcolor{black}{CO$_2$ emissions by energieträger in kilotons - data}
...
## \textcolor{black}{Berlin, MFH, CO$_2$-Emission}
```{r}
...
## \textcolor{black}{Berlin, MFH, CO$_2$-Emission nach Energieträger}
```{r}
...
## \textcolor{black}{Berlin, MFH, CO$_2$ nach Energieträger}
...
## \textcolor{black}{Berlin, MFH, CO$_2$-Anteile nach Energieträger - data}
```{r}
...
## \textcolor{black}{Berlin, MFH, CO$_2$-Anteile nach Energieträger}
...
## \textcolor{black}{Berlin, MFH, spezifische CO$_2$-Emission}
```{r}
...
write.csv(area_shares_absolute,file="./data/presentations/mfh/area_abs_ET_MFH.csv",row.names = FALSE)
write.csv2(area_shares_absolute,file="./data/presentations/mfh/area_abs_ET_MFH_2.csv",row.names = FALSE)

write.csv(energy_shares_absolute,file="./data/presentations/mfh/energy_abs_ET_MFH.csv",row.names = FALSE)
write.csv2(energy_shares_absolute,file="./data/presentations/mfh/energy_abs_ET_MFH_2.csv",row.names = FALSE)

write.csv(co2_emissions_in_kilo_tons,file="./data/presentations/mfh/co2_abs_ET_MFH.csv",row.names = FALSE)
write.csv2(co2_emissions_in_kilo_tons,file="./data/presentations/mfh/co2_abs_ET_MFH_2.csv",row.names = FALSE)

write.csv(totalArea,file="./data/presentations/mfh/totalArea_MFH.csv",row.names = FALSE)
write.csv2(totalArea,file="./data/presentations/mfh/totalArea_MFH_2.csv",row.names = FALSE)
```