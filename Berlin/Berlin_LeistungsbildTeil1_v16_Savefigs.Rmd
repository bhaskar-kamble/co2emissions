...
```{r}
ggplot(prognose_lin , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title = "Polynom 1. Grades")
figIndex <- 1
figIndex <- saveFigure(gtypeForFig=gtypeForFig , 
                       section = i_section,
                       subsection = i_subsection,
...
```{r}
ggplot(prognose_quad , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title = "Polynom 2. Grades")
figIndex <- 1
figIndex <- saveFigure(gtypeForFig=gtypeForFig , 
                       section = i_section,
                       subsection = i_subsection,
...
ggplot(prognose_sfh_lin , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynom 1. Grades")
figIndex <- 1
figIndex <- saveFigure(gtypeForFig=gtypeForFig , 
                       section = i_section,
                       subsection = i_subsection,
...
ggplot(prognose_sfh_quad , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynom 2. Grades")
figIndex <- saveFigure(gtypeForFig=gtypeForFig , 
                       section = i_section,
                       subsection = i_subsection,
                       subsubsection = i_subsubsection, 
...
ggplot(prognose_mfh_lin , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynom 1. Grades")
figIndex <- 1
figIndex <- saveFigure(gtypeForFig=gtypeForFig , 
                       section = i_section,
                       subsection = i_subsection,
...
ggplot(prognose_mfh_quad , aes(x=abrechnungsjahr , y = pred))+geom_point()+labs(title="Polynom 2. Grades")
figIndex <- saveFigure(gtypeForFig=gtypeForFig , 
                       section = i_section,
                       subsection = i_subsection,
                       subsubsection = i_subsubsection, 
